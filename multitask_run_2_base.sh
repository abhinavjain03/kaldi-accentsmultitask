...
proportional_shrink=15

. utils/parse_options.sh

affix=acc300btn_tdnn1024_10shrink_0.5_0.5_withcontext
...
[ ! -f local_opt.conf ] && echo 'the file local_opt.conf does not exist! Read README.txt for more details.' && exit 1;
